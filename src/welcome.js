...
// import beervid from "./assets/images/beer-vid.mp4";
// import fivecans1 from "./assets/images/five-can-1.webp";
// import fivecans2 from "./assets/images/five-can-2.webp";
// import fivecans3 from "./assets/images/five-can-3.webp";
// import fivecans4 from "./assets/images/five-can-4.webp";
// import canimg1 from "./assets/images/can-img-1.webp";
// import canimg2 from "./assets/images/can-img-2.webp";
// import canimg3 from "./assets/images/can-img-3.webp";
// import canimg4 from "./assets/images/can-img-4.webp";
...
// import newsimg1 from "./assets/images/news-img-1.webp";
// import newsimg2 from "./assets/images/news-img-2.webp";
// import newsimg3 from "./assets/images/news-img-3.webp";
...
//       <section className='banner-vid'>
//         <Container fluid>
//           <video width="100%" height="100%" autoPlay loop muted controls={false}>
//             <source src={beervid} type="video/mp4" />
//           </video>
//           <div className="clip-path-section">
//             <h1>KEEPP. BEER. FUN.</h1><br></br>
//             <p>We're serious about keeping beer fun.</p><br></br>
//             <p>At Great Notion, we put care and creativity into each beer we brew, from classic lagers and hazy IPAs to off-the-wall sours and stouts. And with online ordering, the Great Notion App, and eight locations along the West Coast, it's never been easier for you to keep beer fun too.</p>
//           </div>
//         </Container>
//       </section>
...
//           <Row>
//             <Col md={2}>
//               <div className="drop-friday-btn">
//                 <Button>New brews drop on friday!</Button>
//               </div>
//             </Col>
//             <Col md={8}>
//               <div className='flexx'>
//                 <div className='beer-cans'>
//                   <img src={fivecans1} alt='' />
//                 </div>

//                 <div className='beer-cans'>
//                   <img src={fivecans2} alt='' />
//                 </div>

//                 <div className='beer-cans'>
//                   <img src={fivecans3} alt='' />
//                 </div>

//                 <div className='beer-cans'>
//                   <img src={fivecans4} alt='' />
//                 </div>
//               </div>
//             </Col>
//             <Col md={2}></Col>
...
//             <p>German Doppelbock Recipe Kit | 5-gallon All-Grain Beer  Ingredients Kit</p>
//           </div>
...
//       <section className='notions'>
//         <Container fluid>
//           <div className='notions-text'>
//             <h2>12 NOTIONS</h2>
//             <h4>1 BOX. 12 BEERS.</h4>
//             <h4>EVERY MONTH.</h4>
//             <Button>Subscribe by 3/25 for April</Button>
//           </div>
//         </Container>
//       </section>
...
//             <p>The beers you know, the beers you love.</p>
//             <p></p>
//           </div>
...
//                 <div class='can-img-text'>
//                   <h5>
//                     American Pale Ale TrueBrew™ Recipe Kit
//                   </h5>
//                   <h5>$42.99</h5>
//                 </div>
//               </div>
...
//                 <div class='can-img-text'>
//                   <h5>
//                     Belgian Saison TrueBrew™ Extract Recipe Kit
//                   </h5>
//                   <h5>$39.99</h5>
//                 </div>
//               </div>
...
//                 <div class='can-img-text'>
//                   <h5>
//                     Bohemian Pilsner TrueBrew™ Recipe Kit
//                   </h5>
//                   <h5>$44.99</h5>
//                 </div>
//               </div>
...
//                 <div class='can-img-text'>
//                   <h5>
//                     British Brown Ale TrueBrew™ Extract Recipe Kit
//                   </h5>
//                   <h5>$39.99</h5>
//                 </div>
//               </div>
...
//                 <h3>Leap Beer! Buy 4+ 4 Packs, get 1 for a penny</h3>
//                 <h4>February 29, 2024</h4>
//                 <p>On Leap Day only, pick up your order 4 or more 4packs and get a bonus 4pack for a penny.</p>
//               </div>
//             </Col>
//             <Col md={4}>
//               <div className='news-card'>
//                 <img src={newsimg2} alt='' />
//                 <h3>12 Notions - April 2024 Box</h3>
//                 <h4>February 26, 2024</h4>
//                 <p>Pickup and shipping information for April 2024 12 Notions.</p>
//               </div>
//             </Col>
//             <Col md={4}>
//               <div className='news-card'>
//                 <img src={newsimg3} alt='' />
//                 <h3>8TH ANNIVERSARY</h3>
//                 <h4>February 21, 2024</h4>
//                 <p>We're celebrating our 8 year anniversary with specials + a party on the 24th!</p>
//               </div>
//             </Col>
//           </Row>
//           <div className="view-all">
...
//           <Row>
//             <Col md={3}>
//               <div className='cta-card one'>
//                 <span><img src={instagram} alt='' /></span>
//               </div>
//             </Col>
//             <Col md={3}>
//               <div className='cta-card two'>
//                 <span><img src={instagram} alt='' /></span>
//               </div>
//             </Col>
//             <Col md={3}>
//               <div className='cta-card three'>
//                 <span><img src={instagram} alt='' /></span>
//               </div>
//             </Col>
//             <Col md={3}>
//               <div className='cta-card four'>
//                 <span><img src={instagram} alt='' /></span>
//               </div>
//             </Col>
//           </Row>
...
//       <section className='shop-latest two'>
//         <Container>
//           <div className='shop-latest-title'>
//             <h4>CORE BEERS</h4>
//             {/* <p>The beers you know, the beers you love.</p> */}
...
//                   <h5>$39.99</h5>
//                 </div>
//                 <img className='sold-out' src={soldout} alt=''/>
//               </div>
//             </Col>
